...
thingsThatShouldNotEnterIntheTree.push_back(string { "a" }).push_back(string { "an" }).push_back(
string { "the" }).push_back(string { "no" }).push_back(string { "for" }).push_back(string { "and" }).push_back(
string { "nor" }).push_back(string { "but" }).push_back(string {
"or" }).push_back(string { "yet" }).push_back(string { "so" }).push_back(string { "I" }).push_back(string { "me" }).push_back(
...
"them" }).push_back(string { "what" }).push_back(string { "which" }).push_back(
string { "who" }).push_back(string { "whom" }).push_back(string {
"whose" }).push_back(string { "whichever" }).push_back(string {
"whoever" }).push_back(string { "whomever" }).push_back(string { "aboard" }).push_back(string { "about" }).push_back(
...
"without" }).push_back(string { "this" }).push_back(string { "these" }).push_back(
string { "that" }).push_back(string { "those" }).push_back(string { "myself" }).push_back(string { "ourselves" }).push_back(
string { "yourself" }).push_back(string { "yourselves" }).push_back(
string { "himself" }).push_back(string { "herself" }).push_back(
string { "itself" }).push_back(string { "themselves" }).push_back(string { "anybody" }).push_back(string { "anyone" }).push_back(
...
"some" }).push_back(string { "my" }).push_back(string { "your" }).push_back(
...
string { "yours" }).push_back(string { "theirs" });
	...
	for (auto manual : manuals){
		...
		while(textStream >> word){
			...
			if(!thingsThatShouldNotEnterIntheTree.has(word)){
				...
				{
					primaryKeyTree.find(search).manualNames.push_back(manual.name);
				}
			}
		}
	}
